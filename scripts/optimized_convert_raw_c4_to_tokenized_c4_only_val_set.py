...
def main():
    ...
    parser.add_argument("--val_tokens", type=int, default=10000000)
    ...
    # Save final dataset
    DatasetDict({"validation": val_ds}).save_to_disk(final_path)
    ...
    DatasetDict({"validation": val_ds}).save_to_disk(args.output_dir)
